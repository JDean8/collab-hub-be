...
export const projects: Project[] = [
  ...
  },
  {
    ...
    project_description:
      "Seeking driven developers eager to revolutionize TypeScript education! I'm embarking on an exciting journey to develop a web app tailored for beginners diving into TypeScript. If you're passionate about empowering learners with an intuitive platform, join me in creating an interactive space that simplifies TypeScript concepts, making learning an engaging and rewarding experience. Let's collaborate and build a gateway for aspiring developers to master TypeScript together!",
    project_created_at: 1669852800000,
    required_members: 3,
  },
  {
    ...
    project_description:
      "Attention iOS developers with a passion for social connection! I'm initiating an exciting project to develop an iOS app dedicated to helping users find new friends. If you're enthusiastic about crafting a platform that fosters meaningful connections and enriches lives, join me in creating an app that redefines how friendships are formed in the digital era. Let's collaborate and build an innovative space for individuals to discover and bond with like-minded friends!",
    project_created_at: 1669852800000,
    required_members: 3,
  },
  {
    ...
    project_description:
      "Calling all app developers who love our furry friends! I'm embarking on an exciting project to create an app where dogs can connect for playful meet-ups and socializing. If you're passionate about enhancing the social lives of our canine companions and their owners, join me in crafting an innovative platform that brings joy and community to the world of dogs. Let's collaborate and build an app that makes tail-wagging meet-ups a paw-sitively delightful experience!",
    project_created_at: 1669852800000,
    required_members: 3,
  },
  {
